...
class SensorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.EnviarDado = channel.unary_unary(
                ...
                request_serializer=sensores__pb2.DadoSensor.SerializeToString,
...
def add_SensorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'EnviarDado': grpc.unary_unary_rpc_method_handler(
                    servicer.EnviarDado,
                    request_deserializer=sensores__pb2.DadoSensor.FromString,
...
class SensorService(object):
    ...
    def EnviarDado(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/SensorService/EnviarDado',
            sensores__pb2.DadoSensor.SerializeToString,
